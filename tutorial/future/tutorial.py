...
params = {
    ...
    "sim": 0, "num_hours": 24, "num_nodes": 1, "procs_per_node": 32}
...
parser.add_argument('--run_type', '-r', type=int, default=0, help="0: run single simulation on host, 1: run batch on host, 2: submit batch to scheduler")
