...
#
# Requirements:
#   This FEASST Script uses a specific branch and commit of the FEASST
#   soure code, as it utilizes tutorial-specific functions. Checkout the
#   specific release of FEASST via:
#
#   git checkout <tag/release name>
#
