...
parser.add_argument('--trials_per_iteration', type=int, default=1e5, help='like cycles, but not necessary num_particles')
parser.add_argument('--equilibration_iterations', type=int, default=1e1)
