...
int main(int argc, char** argv) {  // CO2, SRSW_EOSTMMC

  int openMP = 0;
  int nMolMax = 5, nMolMin = 0, nfreq = 1e5, ncfreq = 1e5;
  double rCut = 15., temp = 525, lnz = -8.14, boxl = 30.;
