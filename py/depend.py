...
#    if 'opt_lj' in include_plugin: select_classes.append("")
  ...
  if 'gibbs' in include_plugin: select_classes.append("TrialGibbsParticleTransfer")
  if 'gibbs' in include_plugin: select_classes.append("TrialGibbsParticleTransferOneWay")
