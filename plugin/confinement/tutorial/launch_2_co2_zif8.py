...
Movie trials_per_write {trials_per_iteration} output_file {prefix}{node}s[sim_index]_eq.xyz stop_after_iteration 1 group fluid
Movie trials_per_write {trials_per_iteration} output_file {prefix}{node}s[sim_index].xyz start_after_iteration 1 group fluid
