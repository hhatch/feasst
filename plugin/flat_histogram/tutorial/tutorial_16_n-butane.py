...
def mc(thread, mn, mx):
    ...
    mc.add(fst.MakeTrialGrow(fst.ArgsVector([
        {"particle_type": "0", "weight": "1",
         "bond": "true", "mobile_site": "2", "anchor_site": "3"},
        {"angle": "true", "mobile_site": "1", "anchor_site": "2", "anchor_site2": "3"},
        {"dihedral": "true", "mobile_site": "0", "anchor_site": "1", "anchor_site2": "2", "anchor_site3": "3"},
    ]), fst.args({"reference_index": ref, "num_steps": num})))
    mc.add(fst.MakeTrialGrow(fst.ArgsVector([
        {"particle_type": "0", "weight": "1",
