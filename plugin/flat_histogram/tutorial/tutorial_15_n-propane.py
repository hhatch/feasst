...
parser.add_argument("--max_particles", type=int, help="maximum number of particles", default=180)
parser.add_argument("--temperature", type=float, help="temperature in Kelvin", default=344)
...
def mc(thread, mn, mx):
    ...
    mc.add(fst.MakeTrialGrow(fst.ArgsVector([
        {"transfer": "true", "particle_type": "0", "site": "0", "weight": "8"},
    ...
    mc.add(fst.MakeTrialGrow(fst.ArgsVector([
        {"particle_type": "0", "weight": "1",
         "bond": "true", "mobile_site": "1", "anchor_site": "2"},
        {"angle": "true", "mobile_site": "0", "anchor_site": "1", "anchor_site2": "2"},
    ]), fst.args({"reference_index": ref, "num_steps": num})))
    mc.add(fst.MakeTrialGrow(fst.ArgsVector([
        {"particle_type": "0", "weight": "1",
